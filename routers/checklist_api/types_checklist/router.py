...
router_type_checklist = APIRouter(prefix='/type_checklist')
...
@router_type_checklist.get('/getAll', tags=['type_checklist'])
...
@router_type_checklist.post('', tags=['type_checklist'])
...
@router_type_checklist.get('/{type_id}', tags=['type_checklist'])
...
@router_type_checklist.delete('/{type_id}', tags=['type_checklist'])
...
@router_type_checklist.patch('/{type_id}', tags=['type_checklist'])
...
@router_type_checklist.get('/{type_checklist_id}/create_template', tags=['type_checklist'])
...
async def get_operations_by_type(id_type: int):
    ...
    # operations = reformat_type_checklist_operations(operations)
